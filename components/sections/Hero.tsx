      ...
      {words.map((word, wordIndex) => (
        <div key={wordIndex} className="inline-block mr-1">
          {word.split('').map((char, charIndex) => (
            <motion.span
              key={charIndex}
              className={`inline-block${rainbow ? ' purple-gradient-text' : ''}`}
    ...
    <section className="w-full px-4 min-h-screen flex items-center justify-center pt-16 md:pt-24 pb-16 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full">
        <div className="flex flex-col items-center text-center space-y-8 w-full">
          <div className="space-y-6 w-full max-w-5xl">
            ...
            <motion.p
              className="text-lg md:text-xl text-purple-400 max-w-2xl mx-auto leading-relaxed"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{
                duration: 1,
              ...
              <ul className="flex gap-6">
                ...
                >
                  <a
                    ...
                    aria-label="LinkedIn"
                    className="flex items-center justify-center w-12 h-12 rounded-full transition-all duration-300 bg-slate-800 group-hover:bg-gradient-to-tr group-hover:from-yellow-400 group-hover:via-pink-500 group-hover:to-purple-600"
                  >
                    <svg
                      ...
                      height={24}
                      fill="currentColor"
                      className="bi bi-linkedin text-white transition-colors duration-300"
                      viewBox="0 0 16 16"
                    >
                ...
                >
                  ...
                  >
                    <svg
                      ...
                      height={24}
                      fill="currentColor"
                      className="bi bi-github text-white transition-colors duration-300"
                      viewBox="0 0 16 16"
                    >
      ...
      <style>{`
        ...
        .purple-gradient-text {
          ...
          color: transparent;
          filter: drop-shadow(0 0 3px rgba(162, 28, 175, 0.3));
        }
        /* Puedes agregar animación si lo deseas, pero aquí lo dejamos estático para armonía */
